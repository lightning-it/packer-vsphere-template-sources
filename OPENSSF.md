...
- Repository: `packer-vsphere-template-sources`
- Visibility: `public`
...
Enrolled in OpenSSF Best Practices. The badge is emitted from the central release-model inventory using project `13889` with target level `passing`.
